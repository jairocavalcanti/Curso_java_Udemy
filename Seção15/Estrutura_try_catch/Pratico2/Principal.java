        ...
        case "1":
          ...
          if (vector.length == 0) {
            ...
            try {
              ...
              System.out.println("----");
              System.out
                  .println("!! Apenas entradas numéricas inteiras são permitidas na criação de tamanho dos vetores !!");
              scanner.nextLine(); // Limpa o buffer do scanner
              System.out.println("----");
              // usamos scanner.nextLine() para limpar o buffer do Scanner após capturar uma
              // exceção de entrada incorreta
            }
